    ...
    <form @submit.prevent="submit" name="myform" class="currency_validate">
        ...
        >
            <div class="input-group mb-3">
                ...
                >
                    <option value="">Select</option>
                    <option value="bank">Electronic Bank transfer</option>
                    <option value="paypal">PayPal</option>
                    <option value="card">Credit/Debit Card</option>
                    <option value="card">Check</option>
                    <option value="card">Gift cards</option>
                    <option value="card">Cash in person</option>
                </select>
            </div>
        </validate-field>
        ...
        <!--  <div class="d-flex justify-content-between mb-3">
            ...
            <h6 class="mb-0">5000$ remaining</h6>
        </div> !-->
