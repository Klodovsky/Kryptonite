                    ...
                    >
                        <div class="form-row">
                            <validate-field
                                title="Your Name"
                                field="full-name"
                                :validations.sync="$v.fullName"
                                class="col-xl-6"
                            />
                            <validate-field
                                title="Email"
                                field="email"
                                :validations.sync="$v.email"
                                class="col-xl-6"
                            />
                            <validate-field
                                title="Date of Birth"
                                field="dob"
                                :validations.sync="$v.dob"
                                type="date"
                                class="col-xl-6"
                            />
                            <validate-field
                                ...
                                :validations.sync="$v.presentAddress"
                                class="col-xl-6"
                            />
                            <validate-field
                                title="Permanent Address"
                                field="permanent-address"
                                :validations.sync="$v.permanentAddress"
                                class="col-xl-6"
                            />
                            <validate-field
                                title="City"
                                field="city"
                                :validations.sync="$v.city"
                                class="col-xl-6"
                            />
                            <validate-field
                                title="Zip Code"
                                field="postal"
                                :validations.sync="$v.postal"
                                class="col-xl-6"
                            />
