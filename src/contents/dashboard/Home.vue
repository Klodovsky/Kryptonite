    ...
    <content-body>
        <div class="row">
                    ...
                    <div class="card-header py-0">
                        ...
                        <div class="duration-option">
                            <a
                                ...
                                :id="name"
                                :class="{
                                    active: activeDurationOption === index,
                                }"
            ...
            <div class="col-xl-3 col-lg-12 col-xxl-12">
                <div class="card">
                    <div class="card-header border-0 py-0">
                        <h4 class="card-title">Follow trending coins</h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                                    ...
                                    >
                                        <div class="widget-stat">
                                            <div class="coin-title">
                                                ...
                                                ></span>
                                                <h5
                                                    class="d-inline-block ml-2 mb-3"
                                                >
                                ...
                                <table class="table mb-0 table-responsive-sm">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                Using - Bank checkings ending in
                                                *********6640
                                            </td>
                                            <td class="text-success">
                                                +0.0033 BTC
            ...
            <template v-slot:toast-title>
                <div class="d-flex flex-grow-1 align-items-baseline">
                    <b-img
                        ...
                        align="center"
                    ></b-img>
                    <strong class="mr-auto">You have a pending payment!</strong>
                    <small class="text-muted mr-2">2 days ago</small>
                </div>
            </template>
            An escrow holdback is money set aside at the closing of a home that
            will be refunded once repairs are completed. Because a portion of
            the seller or buyer proceeds are held in an escrow account until the
...
export default {
    ...
    created() {
        ...
        axios
            ...
            .then((res) => {
                this.cryptos = res.data.DISPLAY;
                const myObjStr = JSON.stringify(cryptos);
